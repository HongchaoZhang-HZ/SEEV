...
def main(args):
    ...
    V_contour_experiment = CLFContourExperiment(
        ...
        n_grid=25,
        x_axis_index=Darboux.X,
        y_axis_index=Darboux.Y,
        x_axis_label="$x$",
        y_axis_label="$y$",
    )
    rollout_state_space_experiment = RolloutStateSpaceExperiment(
        "Rollout State Space",
        start_x,
        plot_x_index=Darboux.X,
        plot_x_label="$x$",
        plot_y_index=Darboux.Y,
        plot_y_label="$y$",
    ...
    model_name = "darboux_commit_{}_layers_{}_size_{}_seed_{}_certify_{}".format(
        current_git_hash(),
        cbf_hidden_layers,
        cbf_hidden_size,
        args.random_seed,
